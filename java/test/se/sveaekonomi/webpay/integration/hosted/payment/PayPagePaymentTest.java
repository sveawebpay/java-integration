...
public class PayPagePaymentTest {
    ...
    public void setExcludePaymentMethodsTestDefaultConfigurationNoExcluded() {
        PayPagePayment payPagePayment = new PayPagePayment(null);        
        payPagePayment.excludePaymentMethods();
    ...
    public void testBuildPayPagePaymentWithExcludepaymentMethods() throws ValidationException, Exception{  
       ...
       String expected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><!--Message generated by Integration package Java--><payment><customerrefno>33</customerrefno><returnurl>http://myurl.se</returnurl><currency>SEK</currency><amount>18750</amount><lang>en</lang><vat>3750</vat><orderrows><row><sku>1</sku><name>Prod</name><description>Specification</description><amount>12500</amount><vat>2500</vat><quantity>2</quantity><unit>st</unit></row><row><sku>33</sku><name></name><description>Specification</description><amount>6250</amount><vat>1250</vat><quantity>1</quantity></row><row><sku>1</sku><name>Relative</name><description>RelativeDiscount</description><amount>-12500</amount><vat>-2500</vat><quantity>1</quantity><unit>st</unit></row></orderrows><excludepaymentmethods><exclude>SVEAINVOICESE</exclude><exclude>KORTCERT</exclude></excludepaymentmethods></payment>";
    ...
    public void testPayPagePaymentIncludePaymentMethodsEmpty() throws ValidationException, Exception {
        ...
        assertEquals(PAYMENTMETHOD.SVEAINVOICESE.toString(), paymentMethod);
        assertEquals(PAYMENTMETHOD.DBSWEDBANKSE.toString(), paymentMethod2);
    }
