...
public class HostedXmlBuilderTest {
    ...
    public void testOrderRowXml() throws Exception {
        ...
        //expected xml string tested with tool in hosted admin
        final String EXPECTED_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><!--Message generated by Integration package Java--><payment><customerrefno>nr26</customerrefno><returnurl>http://myurl.se</returnurl><currency>SEK</currency><amount>500</amount><lang>sv</lang><customer><ssn>666666</ssn><housenumber>23</housenumber><zip>9999</zip><address>Gatan</address><city>Stan</city><email>test@svea.com</email><address2>c/o Eriksson</address2><email>test@svea.com</email><phone>999999</phone><country>SE</country></customer><vat>100</vat><ipaddress>123.123.123.123</ipaddress><orderrows><row><sku>0</sku><name>Product</name><description>Good product</description><amount>500</amount><vat>100</vat><quantity>1</quantity><unit>kg</unit></row></orderrows><excludepaymentmethods></excludepaymentmethods><iscompany>true</iscompany></payment>";
        assertEquals(EXPECTED_XML, xml);
    }
    ...
    public void testCardPaymentSpecificXml() throws Exception {
    	xml = WebPay.createOrder()
    			...
    			.getXmlMessage();
    	 //expected xml string tested with tool in hosted admin       
        final String EXPECTED_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><!--Message generated by Integration package Java--><payment><customerrefno>nr26</customerrefno><returnurl>https://test.sveaekonomi.se/webpay/admin/merchantresponsetest.xhtm</returnurl><currency>SEK</currency><amount>500</amount><lang>en</lang><customer><ssn>666666</ssn><housenumber>23</housenumber><zip>9999</zip><address>Gatan</address><city>Stan</city><email>test@svea.com</email><address2>c/o Eriksson</address2><email>test@svea.com</email><phone>999999</phone><country>SE</country></customer><vat>100</vat><ipaddress>123.123.123.123</ipaddress><orderrows><row><sku>0</sku><name></name><description></description><amount>500</amount><vat>100</vat><quantity>1</quantity></row></orderrows><excludepaymentmethods><exclude>PAYPAL</exclude><exclude>DBNORDEASE</exclude><exclude>DBSEBSE</exclude><exclude>DBSEBFTGSE</exclude><exclude>DBSHBSE</exclude><exclude>DBSWEDBANKSE</exclude><exclude>BANKAXESS</exclude><exclude>SVEAINVOICESE</exclude><exclude>SVEAINVOICEEU_SE</exclude><exclude>SVEASPLITSE</exclude><exclude>SVEASPLITEU_SE</exclude><exclude>SVEAINVOICEEU_DE</exclude><exclude>SVEASPLITEU_DE</exclude><exclude>SVEAINVOICEEU_DK</exclude><exclude>SVEASPLITEU_DK</exclude><exclude>SVEAINVOICEEU_FI</exclude><exclude>SVEASPLITEU_FI</exclude><exclude>SVEAINVOICEEU_NL</exclude><exclude>SVEASPLITEU_NL</exclude><exclude>SVEAINVOICEEU_NO</exclude><exclude>SVEASPLITEU_NO</exclude></excludepaymentmethods><iscompany>true</iscompany></payment>";
        assertEquals(EXPECTED_XML, xml);
    }
