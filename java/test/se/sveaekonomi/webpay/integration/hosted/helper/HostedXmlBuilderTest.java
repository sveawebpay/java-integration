...
public class HostedXmlBuilderTest {
    ...
    public void testOrderRowXml() {
		...
		//<?xml version=\"1.0\" encoding=\"UTF-8\"?><!--Message generated by Integration package Java -->
		//<payment>
		//	<customerrefno>nr26</customerrefno>
		//	<currency>SEK</currency>
		//	<amount>25000</amount>
		//	<vat>2500</vat>
		//	<returnurl>http://myurl.se</returnurl>
		...
		//</payment>
        final String EXPECTED_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><!--{\"X-Svea-Integration-Version\":\"Integration package default SveaTestConfigurationProvider.\",\"X-Svea-Integration-Platform\":\"Integration package default SveaTestConfigurationProvider.\",\"X-Svea-Library-Name\":\"Java Integration Package\",\"X-Svea-Integration-Company\":\"Integration package default SveaTestConfigurationProvider.\",\"X-Svea-Library-Version\":\"2.0.2\"}--><payment><customerrefno>nr26</customerrefno><currency>SEK</currency><amount>25000</amount><vat>5000</vat><returnurl>http://myurl.se</returnurl><iscompany>false</iscompany><customer><ssn>666666</ssn><country>SE</country></customer><orderrows><row><sku></sku><name></name><description></description><amount>12500</amount><vat>2500</vat><quantity>2.0</quantity></row></orderrows><addinvoicefee>false</addinvoicefee></payment>";
        assertEquals(EXPECTED_XML, xml);
    }
    
    @Test
    public void testOrderRowAndShippingFeeXml() {
        order = WebPay.createOrder(SveaConfig.getDefaultConfig())
                .setCountryCode(TestingTool.DefaultTestCountryCode)
                .setCurrency(TestingTool.DefaultTestCurrency)
                .setClientOrderNumber("nr26")
		...
		//	<addinvoicefee>false</addinvoicefee>
		//</payment>
        final String EXPECTED_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><!--{\"X-Svea-Integration-Version\":\"Integration package default SveaTestConfigurationProvider.\",\"X-Svea-Integration-Platform\":\"Integration package default SveaTestConfigurationProvider.\",\"X-Svea-Library-Name\":\"Java Integration Package\",\"X-Svea-Integration-Company\":\"Integration package default SveaTestConfigurationProvider.\",\"X-Svea-Library-Version\":\"2.0.2\"}--><payment><customerrefno>nr26</customerrefno><currency>SEK</currency><amount>30300</amount><vat>5300</vat><returnurl>http://myurl.se</returnurl><iscompany>false</iscompany><customer><ssn>666666</ssn><country>SE</country></customer><orderrows><row><sku></sku><name></name><description></description><amount>12500</amount><vat>2500</vat><quantity>2.0</quantity></row><row><name></name><description></description><amount>5300</amount><vat>300</vat><quantity>1.0</quantity></row></orderrows><addinvoicefee>false</addinvoicefee></payment>";
        assertEquals(EXPECTED_XML, xml);
    }
    
    @Test
    public void testOrderRowAndShippingFeeAndInvoiceFeeXml() {
        order = WebPay.createOrder(SveaConfig.getDefaultConfig())
                .setCountryCode(TestingTool.DefaultTestCountryCode)
                .setCurrency(TestingTool.DefaultTestCurrency)
                .setClientOrderNumber("nr26")
		...
		//	<addinvoicefee>false</addinvoicefee>
		//</payment>
        final String EXPECTED_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><!--{\"X-Svea-Integration-Version\":\"Integration package default SveaTestConfigurationProvider.\",\"X-Svea-Integration-Platform\":\"Integration package default SveaTestConfigurationProvider.\",\"X-Svea-Library-Name\":\"Java Integration Package\",\"X-Svea-Integration-Company\":\"Integration package default SveaTestConfigurationProvider.\",\"X-Svea-Library-Version\":\"2.0.2\"}--><payment><customerrefno>nr26</customerrefno><currency>SEK</currency><amount>33200</amount><vat>5880</vat><returnurl>http://myurl.se</returnurl><iscompany>false</iscompany><customer><ssn>666666</ssn><country>SE</country></customer><orderrows><row><sku></sku><name></name><description></description><amount>12500</amount><vat>2500</vat><quantity>2.0</quantity></row><row><name></name><description></description><amount>5300</amount><vat>300</vat><quantity>1.0</quantity></row><row><name></name><description></description><amount>2900</amount><vat>580</vat><quantity>1.0</quantity></row></orderrows><addinvoicefee>false</addinvoicefee></payment>";
        assertEquals(EXPECTED_XML, xml);
    }
