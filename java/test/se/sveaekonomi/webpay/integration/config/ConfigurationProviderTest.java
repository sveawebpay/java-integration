...
public class ConfigurationProviderTest {
    ...
    public void testGetDefaultConfigSe() throws MalformedURLException
    {
        ...
        assertEquals(defaultConf.getEndPoint(PAYMENTTYPE.HOSTED), new URL("https://webpaypaymentgatewaystage.svea.com/webpay/payment"));
    ...
    {
        assertEquals(new URL("https://webpaypaymentgateway.svea.com/webpay/payment"), SveaConfig.getProdPayPageUrl());
