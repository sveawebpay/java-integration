...
public class QueryTransactionRequest extends HostedAdminRequest implements Requestable {
	...
	public QueryTransactionResponse parseResponse(String message) {
		return new QueryTransactionResponse(message, this.config.getSecretWord(PAYMENTTYPE.HOSTED, this.getCountryCode()));
	}    
